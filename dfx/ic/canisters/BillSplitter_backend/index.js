...
import { idlFactory } from './BillSplitter_backend.did.js';
export { idlFactory } from './BillSplitter_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BILLSPLITTER_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./BillSplitter_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the BillSplitter_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./BillSplitter_backend.did.js")._SERVICE>}
 */
export const BillSplitter_backend = createActor(canisterId);
